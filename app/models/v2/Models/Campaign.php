...
use Session, Mailer,  MIS, SiteSettings, Config, SMS, User;
...
class Campaign extends Eloquent
{
	...
	public function getOpensTrackAttribute($value)
	{
		if ($value == null) {
			return [];
		}
	...
	public function setOpensTrackAttribute($value)
	{
		$this->attributes['opens_track'] =  json_encode($value);
	}
}
