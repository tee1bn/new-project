 ...
 * 
 */
class ManualChipperCash implements PaymentMethodInterface
{
    private $name = 'manual_chipper_cash';
    ...
    function __construct()
    {
        ...
        $this->shop = null;
        $settings = SiteSettings::find_criteria('manual_chipper_cash')->settingsArray;
    ...
    public function initializePayment()
    {
        ...
        $instruction = str_replace("[ORDER_REF]", "<b>$order_ref</b>", CMS::fetch('manual_chipper_cash'));
