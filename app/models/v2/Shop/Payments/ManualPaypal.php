 ...
 * 
 */
class ManualPaypal implements PaymentMethodInterface
{
    private $name = 'manual_paypal';
    ...
    function __construct()
    {
        ...
        $this->shop = null;
        $settings = SiteSettings::find_criteria('manual_paypal')->settingsArray;
    ...
    public function initializePayment()
    {
        ...
        $instruction = str_replace(
            ...
            ["<b>$order_ref</b>", "$amount", "USD"],
            CMS::fetch('manual_paypal')
        );
