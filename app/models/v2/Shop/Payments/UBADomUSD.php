 ...
 * 
 */
class UBADomUSD implements PaymentMethodInterface
{
    private $name = 'uba_dom_usd';
    ...
    function __construct()
    {
        ...
        $this->shop = null;
        $settings = SiteSettings::find_criteria('uba_dom_usd')->settingsArray;
    ...
    public function initializePayment()
    {
        ...
        $instruction = str_replace("[ORDER_REF]", "<b>$order_ref</b>", CMS::fetch('uba_dom_usd'));
