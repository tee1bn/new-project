 ...
 * 
 */
class ManualMobileMoneyGhana implements PaymentMethodInterface
{
    private $name = 'manual_mobile_money_ghana';
    ...
    function __construct()
    {
        ...
        $this->shop = null;
        $settings = SiteSettings::find_criteria('manual_mobile_money_ghana')->settingsArray;
    ...
    public function initializePayment()
    {
        ...
        $instruction = str_replace(
            ...
            ["<b onclick=\"copy_text('$order_ref')\">$order_ref</b>", "$amount", "$code"],
            CMS::fetch('manual_mobile_money_ghana')
        );
        $payment_details = [
            'gateway' => $this->name,
            'ref' => $order_ref,
