 ...
 * 
 */
class PerfectMoney implements PaymentMethodInterface
{
	private $name = 'perfect_money';
	...
	function __construct()
	{
		...
		$settings = SiteSettings::find_criteria('perfect_money_keys')->settingsArray;
	...
	public function goToGateway()
	{
		...
		$controller->view('auth/perfect_money');
		return;
		Redirect::to("shop/perfect_money/?$callback_param");	
	}
