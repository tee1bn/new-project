              ...
              <div class="card-body row collapse show" id="plan<?=$plan->id;?>">
                ...
                <form class="col-12 ajax_form" method="POST" action="<?=domain;?>/admin/update_account_plans">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      <label>Passive investment duration(wks) </label>
                      <input type="number" step=""  name="details[driving_factors][passive_investment_duration_in_weeks]" 
                       required="" value="<?=$plan->DetailsArray['driving_factors']['passive_investment_duration_in_weeks'];?>" class="form-control">
                    </div>
