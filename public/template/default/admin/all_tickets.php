              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td>
                      <?= $i++; ?>.
                      <a href="<?= $ticket->adminLink; ?>">
                        <?= $ticket->code; ?></a>
                      <?= $ticket->displayStatus; ?>
                    </td>
                    <td><?= $ticket->displayClient; ?></td>
                    <td><?= $ticket->subject_of_ticket; ?></td>
                    <td><span class="badge badge-secondary"><?= $ticket->created_at->format("Y-m-d h:iA"); ?></span></td>
                    <td>
                      <div class="btn-group btn-group-sm">
                        <a class="btn btn-sm btn-outline-dark" href="<?= $ticket->adminLink; ?>">View</a>
                        <a class="btn btn-sm btn-outline-dark" onclick="$confirm_dialog = new ConfirmationDialog('<?= $ticket->closeLink; ?>')" href="javascript:void(0);">Close</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
