                        ...
                        <form class="ajax_for" action="<?= domain; ?>/admin-profile/add_admin" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                    ...
                                    <input id="tch3" name="email" required="" value="" data-bts-button-down-class="btn btn-secondary btn-outline" data-bts-button-up-class="btn btn-secondary btn-outline" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                    <span class="input-group-btn input-group-prepend"></span>
                                    <input id="tch3" name="phone" required="" value="" data-bts-button-down-class="btn btn-secondary btn-outline" data-bts-button-up-class="btn btn-secondary btn-outline" class="form-control">
                                </div>
                            </div>
