                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-10">
                                    ...
                                    <select class="form-control" name="category_id">
                                        ...
                                        <?php foreach (v2\Models\CampaignCategory::Active()->get() as $key => $category) : ?>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" onclick="$confirm_dialog= new DialogJS(submit_campaign, ['<?= $publish; ?>'],'Are you sure you want to publish?');" class="btn btn-outline-primary">Publish</button>

                                        <button type="button" onclick="$confirm_dialog= new DialogJS(submit_campaign, ['<?= $send_test; ?>'],'Are you sure you want to send test?');" class="btn btn-outline-primary">Send test</button>
