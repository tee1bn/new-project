        ...
        <div class="btn-group">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <a class="dropdown-item" href="<?= domain; ?>/accounts/chart_of_account_transactions/<?= $chart_of_account->id; ?>">
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td> <?= MIS::money_format($debits[] = $transaction->a_debit ?? 0); ?></td>
                <td><?= MIS::money_format($credits[] = $transaction->a_credit ?? 0); ?></td>
                <td> <?= $transaction->a_post_available_balance; ?></td>
                <td> <?= $transaction->a_post_available_balance; ?></td>
