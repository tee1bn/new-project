               ...
               <form action="<?= $action ?? ''; ?>" method="get" id="filter_form">
                       ...
                       <div class="form-group col-md-6">
                           ...
                           <select class="form-control" name="country">
                               ...
                               <?php foreach (World\Country::all() as $key => $country) : ?>
                                   <option <?= ((isset($sieve['country'])) && ($sieve['country'] == (int)$country->id)) ? 'selected' : ''; ?> value="<?= $country->id; ?>"><?= $country->name; ?></option>
                               <?php endforeach; ?>
                           </select>
                       </div>
                   </div>
                   <div class="row">
                       <div class=" form-group col-sm-6">
                           ...
                           <input placeholder="Start" type="date" value="<?= $sieve['registration']['start_date'] ?? ''; ?>" class="form-control" name="registration[start_date]">
                       </div>


                       <div class=" form-group col-sm-6">
                           <label>* Registration (To)</label>
                           <input type="date" placeholder="End " value="<?= $sieve['registration']['end_date'] ?? ''; ?>" class="form-control" name="registration[end_date]">
                       </div>
