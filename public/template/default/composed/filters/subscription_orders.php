                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <select class="form-control" name="item">
                                                ...
                                                <?php foreach (SiteSettings::getPlans()['plans'] as $key => $value) : ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-xs-12">
                                            ...
                                            <select class="form-control" name="currency">
                                                ...
                                                foreach (SiteSettings::AvailableCurrencies()->sortBy('code') as $key => $global_currency) : ?>
                                                    <option <?= ($global_currency['code'] == $sieve['currency']) ? 'selected' : ''; ?> value="<?= $global_currency['code']; ?>"> <?= $global_currency['code']; ?></option>
                                                <?php endforeach; ?>
