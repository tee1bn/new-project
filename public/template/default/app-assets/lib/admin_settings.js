...
app.controller('Settings', function ($scope, $http) {
	...
	$scope.fetch_payment_gateway_settings = function () {
		$http.get($base_url + "/settings/fetch_payment_gateway_settings/").then(function (response) {
	...
	$scope.fetch_site_settings = function () {
		$http.get($base_url + "/settings/fetch_site_settings/").then(function (response) {
	...
	$scope.fetch_commission_settings = function () {
		$http.get($base_url + "/settings/fetch_commission_settings/").then(function (response) {
	...
	$scope.binary_bonus = function () {
		$http.get($base_url + "/settings/fetch/binary_bonus").then(function (response) {
	...
	$scope.direct_bonus = function () {
		$http.get($base_url + "/settings/fetch/direct_bonus").then(function (response) {
	...
	$scope.matching_bonus = function () {
		$http.get($base_url + "/settings/fetch/matching_bonus").then(function (response) {
	...
	$scope.speaker_bonus = function () {
		$http.get($base_url + "/settings/fetch/speaker_bonus").then(function (response) {
	...
	$scope.office_bonus = function () {
		$http.get($base_url + "/settings/fetch/office_bonus").then(function (response) {
	...
	$scope.auto_bonus = function () {
		$http.get($base_url + "/settings/fetch/auto_bonus").then(function (response) {
	...
	$scope.leadership_ranks = function () {
		$http.get($base_url + "/settings/fetch/leadership_ranks").then(function (response) {
	...
	$scope.rules_settings = function () {
		$http.get($base_url + "/settings/fetch/rules_settings").then(function (response) {
	...
	$scope.live_chat_installation = function () {
		$http.get($base_url + "/settings/fetch/live_chat_installation").then(function (response) {
